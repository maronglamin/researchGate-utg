        ...
        <div class="row justify-content-center">
            <div class="col-md-5">
                <div class="card shadow mb-4">
                            ...
                            <div class="row">
                                ...
                                <div>
                                    ...
                                    if ($_POST) {
                                        ...
                                        $permitQuery = $db->query("SELECT * FROM administrators WHERE email = '$email' AND permitted = 0");
                    ...
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Don't have an acount? <a href="<?= PROOT ?>admin/publisher/components/register-publisher.php">SIGN UP!</a></h6>
                    </div>
                </div>
            </div>
        </div>
